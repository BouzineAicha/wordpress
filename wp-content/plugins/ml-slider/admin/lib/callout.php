...
$metaslider_callout_name = 'gallery';
...
$metaslider_callout_text = sprintf(__('Hey there! We just started working on a brand new gallery extension. <a href="%s">Check it out</a> and let us know what you think!', 'ml-slider'), self_admin_url('admin.php?page=metagallery'));
// $metaslider_callout_text = sprintf(__('Hey there! We just started working on a brand new gallery extension. Check it out and let us know what you think! <a href="%s" onclick="%s">Check it out</a>', 'ml-slider'), self_admin_url('admin.php?page=metaslider'), esc_attr($tour_reset));
